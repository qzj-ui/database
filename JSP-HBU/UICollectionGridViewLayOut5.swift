//
//  UICollectionGridViewLayout3.swift
//  JSP-HBU
//
//  Created by 齐子佳 on 5/27/20.
...
//多列表格组件布局类
class UICollectionGridViewLayout5: UICollectionViewLayout {
    //记录每个单元格的布局属性
    private var itemAttributes: [[UICollectionViewLayoutAttributes]] = []
    private var itemsSize: [NSValue] = []
    private var contentSize: CGSize = CGSize.zero
    //表格组件视图控制器
    var viewController: UICollectionGridViewController5!
